...
\fg{width=0.7\textwidth}{08/img/uml-poli.pdf}
}
...
%\fg{width=1\textwidth}{08/img/layout.pdf}
%}
...
\fr{Esempio applicazione polimorfismo fra classi -- UML}{
  \fg{height=0.8\textheight}{08/img/uml-person.pdf}
}
...
\fr{Come simulare ereditarietà multipla?}{
  \fg{height=0.8\textheight}{08/img/uml-diamond.pdf}
}
...
\fr{UML complessivo}{
  \fg{height=0.8\textheight}{08/img/uml-abstract.pdf}
}
