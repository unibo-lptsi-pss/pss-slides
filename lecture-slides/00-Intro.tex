...
\frs{5}{Docenti}{
  \bl{Titolare del corso: Prof. Mirko Viroli}{
    \iz{ 
      ...
      \item homepage | \texttt{http://mirkoviroli.apice.unibo.it}
    }
  }
  ...
  \bl{Modulo di laboratorio 2: Prof. Angelo Croatti}{
    \iz{ 
      \item e-mail | \texttt{a.croatti@unibo.it}
      \item homepage | \texttt{http://apice.unibo.it/xwiki/bin/view/AngeloCroatti/}
    }
  }
  
  \bl{Tutor: Ing. Roberto Casadei}{
    \iz{ 
