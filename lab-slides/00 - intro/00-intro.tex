...
\begin{frame}{Docenti del Laboratorio}
    \begin{block}{Prof. Angelo Filaseta -- Responsabile Modulo 2}
        \begin{itemize}
            \item mail: \texttt{angelo.filaseta@unibo.it}
            \item ricevimento: su appuntamento, da concordare via mail
        \end{itemize}
    \end{block}
    \begin{block}{Prof. Gianluca Aguzzi -- Responsabile Modulo 3}
        \begin{itemize}
            \item mail: \texttt{gianluca.aguzzi@unibo.it}
            \item ricevimento: su appuntamento, da concordare via mail
        \end{itemize}
    \end{block}
