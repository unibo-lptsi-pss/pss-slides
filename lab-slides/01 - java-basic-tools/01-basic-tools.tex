...
\title[Strumenti di Base] %[{\lab} -- Strumenti di Base]
...
\fg{width=\textwidth}{img/vs-code-startup.png}
\end{frame}
...
\item Apertura VSCode
	\begin{itemize}
	\item[a)] Da terminale: \ttb{vscode} \emph{``percorso alla cartella da aprire''}
...
\fg{width=\textwidth}{img/vs-code.png}
